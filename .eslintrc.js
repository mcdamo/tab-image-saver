...
module.exports = {
  ...
  globals: { chrome: true },
  plugins: ["json", "mocha", "prettier", "promise", "react"],
  ...
  rules: {
    ...
    "no-unused-labels": 2,
    //"no-unused-vars": [2, {"vars": "all", "args": "none"}], // TODO enable
    ...
    //"object-curly-spacing": [2, "never"], // TODO enable
    ...
    //"quotes": [2, "double", "avoid-escape"], // TODO enable
    radix: [2, "always"],
    "require-jsdoc": 0,
    "require-yield": 2,
    ...
    "space-infix-ops": 2,
    "space-unary-ops": 2,
    //"spaced-comment": [2, "always"], // TODO enable
    strict: 0,
